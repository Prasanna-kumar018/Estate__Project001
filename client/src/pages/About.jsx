...
const About = () => {
  return (
    <div className='flex items-center mx-32 flex-col text-xl mt-20'>
      <h1 className='font-bold my-3 text-2xl'>About Kala Estate</h1>
      <p>
        Kala Estate is a leading real estate agency that specializes in
